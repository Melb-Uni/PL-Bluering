...
define(["https://cdnjs.cloudflare.com/ajax/libs/pixi.js/5.1.3/pixi.min.js"], function () {
    ...
    function play(delta, planimation) {
        ...
        for (var i = 0; i < sprites.length; i++) {
            ...
            TweenMax.to(spriteUpdate, 1 , {x:sprites[i].minX * planimation.width, y:sprites[i].minY * planimation.height})
   ...
   /**
     ...
     */
    function update_stage_idx(planimaiton, index){
        planimaiton.currentStage = planimaiton.vfg.visualStages[index].visualSprites
    }
    /**
    ...
    Planimation.prototype = {
        ...
        setVS: function(index){
            this.currentStage = this.vfg.visualStages[index].visualSprites
        },
